...
<br>
<center><h1 style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"> Depósitos </h1></center>
<br>
			...
			data: {
				...
				datasets: [{
					...
					data: [
                        ...
                        '<?php echo $row['0'];
                            $nuevo = $row['0'];
                            $queryUpdate = "UPDATE errores set cantidad = '$nuevo' where tipo = 'Depositos';";
			...
			data: {
				...
				datasets: [{
					...
					data: [
                        ...
                        '<?php echo $row['0'];
                            $nuevo2 = $nuevo + $row['0'];
                            $queryUpdate = "UPDATE errores set cantidad = '$nuevo2' where tipo = 'Depositos';";
                            mysqli_query($conector, $queryUpdate);
                        ?>'
                        <?php } ?>
					],
